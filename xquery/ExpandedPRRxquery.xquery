declare variable $numMainBranches := 39;
declare variable $numTotalBranches := 68;
declare variable $branchLen := 950;
declare variable $branchSpacer := 100;
declare variable $bigCircleExtraSpacer := 100;
declare variable $mainLen := $numTotalBranches * $branchSpacer + $bigCircleExtraSpacer;
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1500 4180">
    ...
    <g alignment-baseline="baseline" transform="translate(200,0)">
        ...
        <g transform="translate(0, {$bigCircleExtraSpacer})">                
            {
                for $mainBranch at $mainBranchNum in //Q{}CT1000/Q{}branch
                    let $branchY := $branchSpacer * $mainBranchNum
                    let $branchName := //Q{}CT1000/Q{}branch[position()=$mainBranchNum]/data(@name)
